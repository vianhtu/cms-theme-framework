...
?>
<div class="<?php echo esc_attr($class_link); ?> cms-fancyboxes-wraper cms-fancybox-layout-2 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
...
<style type="text/css">
  .<?php echo esc_attr($class_link); ?>.cms-fancybox-layout-2 .cms-fancyboxes-readmore a:hover {
