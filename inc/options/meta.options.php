    ...
    function template_page_options() {
        ...
        <div id="cs-blog-metabox" class='cs_metabox'>
            <div id="tab-side-container" class='EasyTabs clearfix'>
                <ul>
                    <li class='cs-tab'><a href="#tabs-general"><i class="dashicons dashicons-admin-settings" title="<?php echo _e('GENERAL', THEMENAME);?>"></i> <span><?php echo _e('GENERAL', THEMENAME);?></span></a></li>
                    <li class='cs-tab'><a href="#tabs-header"><i class="dashicons dashicons-menu" title="<?php echo _e('HEADER', THEMENAME);?>"></i> <span><?php echo _e('HEADER', THEMENAME);?></span></a></li>
                    <li class='cs-tab'><a href="#tabs-page-title"><i class="dashicons dashicons-admin-home" title="<?php echo _e('PAGE TITLE', THEMENAME);?>"></i> <span><?php echo _e('PAGE TITLE', THEMENAME);?></span></a></li>
                </ul>
