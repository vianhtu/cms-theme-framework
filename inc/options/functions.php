        ...
        class Redux_Framework_sample_config {
            ...
            public function setHelpTabs() {
                ...
                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-1',
                    'title'   => esc_html__( 'Theme Information 1', 'cms-theme-framework' ),
                    'content' => esc_html__( 'This is the tab content, HTML is allowed.', 'cms-theme-framework' )
                );

                $this->args['help_tabs'][] = array(
                    'id'      => 'redux-help-tab-2',
                    'title'   => esc_html__( 'Theme Information 2', 'cms-theme-framework' ),
                    'content' => esc_html__( 'This is the tab content, HTML is allowed.', 'cms-theme-framework' )
                );

                // Set the help sidebar
                $this->args['help_sidebar'] = esc_html__( 'This is the sidebar content, HTML is allowed.', 'cms-theme-framework' );
            }
