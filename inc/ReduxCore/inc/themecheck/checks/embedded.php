        ...
        function check( $php_files, $css_files, $other_files ) {
            ...
            if ( $redux ) {
                if ( ! isset( $_POST['redux_wporg'] ) ) {
                    ...
                    $args .= '</ol>';
                    $this->error[] = '<div class="redux-error">' . esc_html__( '<span class="tc-lead tc-recommended">RECOMMENDED</span>: The following arguments MUST be used for WP.org submissions, or you will be rejected because of your Redux configuration.', 'redux-framework' ) . $args . '</div>';
