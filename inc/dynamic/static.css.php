...
class CMSSuperHeroes_StaticCss
{
    ...
    public function generate_file()
    {
        ...
        if (! empty($smof_data)) {
            ...
            $wp_filesystem->put_contents(get_template_directory() . '/assets/scss/options.scss', $this->css_render()); // Save it
            ...
            $wp_filesystem->put_contents(get_template_directory() . '/assets/css/' . $file, $css); // Save it
        }
    }
