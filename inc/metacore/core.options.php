...
if(!class_exists('MetaFramework')){
	...
	class MetaFramework
	{
	     ...
	     * wp_enqueue_style
	     * 
	     * enqueue styles and script for options.
	     * @package MetaFramework
	     */
	    function Scripts()
	    {
	        ...
	        <div class="images-field clearfix">
	            ...
	            foreach ($selected as $value):
	                ...
	                <li class="items" data-id="<?php echo esc_attr($value); ?>" style="background-image:url(<?php echo esc_url($attachment_image[0]);?>);background-size:cover;">
	                    <i class="edit dashicons dashicons-plus-alt" title="<?php esc_html_e('Replace Image', 'cms-theme-framework'); ?>"></i>
	                    <i class="remove dashicons dashicons-dismiss" title="<?php esc_html_e('Remove Image', 'cms-theme-framework'); ?>"></i>
	                </li>
	            <?php endif; endforeach; ?>
	            <?php if($params['field'] != 'single'): ?>
	                <li class="items" data-id=""><i class="add dashicons dashicons-plus-alt" title="<?php esc_html_e('Add Image', 'cms-theme-framework'); ?>"></i></li>
